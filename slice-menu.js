...
window.MENU = [
  {
    ...
    items: [
      ...
      { name: "Six Cheese Pizza", desc: "Provolone, gouda, mozzarella, parmesan, feta, and asiago cheese.", price: 18.95, img: "six-cheese-pizza.jpg", url: S(1000043635, 1000299786) },
      ...
      { name: "Carbonara Pizza", desc: "Mixed cheese, bacon, ham, mushrooms with alfredo sauce.", price: 18.95, img: "carbonara-pizza.jpg", url: S(1000043635, 1000299806) },
      ...
      { name: "Greek Village Pizza", desc: "Olives, onions, green & red peppers, tomatoes, and cheese.", price: 18.95, img: "greek-village-pizza.jpg", url: S(1000043635, 1000299823) },
      { name: "Steak Philly Pizza", desc: "Cheese steak, onions, green peppers, mushrooms and ranch sauce.", price: 18.95, img: "steak-philly-pizza.jpg", url: S(1000043635, 1000299828) },
      { name: "Gyros Pizza", desc: "Cheese, gyros, lettuce, tomatoes, onions and tzatziki sauce.", price: 18.95, img: "gyros-pizza.jpg", url: S(1000043635, 1000299832) },
      { name: "BBQ Pizza", desc: "Special BBQ sauce, cheese, chicken, onions, bacon.", price: 18.95, img: "bbq-pizza.jpg", url: S(1000043635, 1000299838) },
    ],
  },
  {
    id: "pizza",
    ...
    items: [
      { name: "Build Your Own Pizza", desc: "Classic cheese or create your own pizza.", price: 13.95, tag: "Popular", img: "build-your-own-pizza.jpg", url: S(1000043632, 1000299768) },
    ],
  },
  {
    id: "appetizers",
    ...
    items: [
      { name: "Gouda Cheese & Mac Bites", desc: "Crispy bites of creamy gouda mac & cheese.", price: 8.00, img: "gouda-mac-bites.jpg", url: S(1000043662, 1000299907) },
      { name: "Jalapeño Poppers", desc: "Breaded and filled with cheese, fried to golden perfection.", price: 8.00, img: "jalapeno-poppers.jpg", url: S(1000043662, 1000299913) },
      { name: "Hummus with Pita Bread", desc: "Creamy house hummus with warm pita.", price: 5.50, img: "hummus-pita.jpg", url: S(1000043662, 1000299959) },
      { name: "Mozzarella Cheese Sticks", desc: "Crispy outside, gooey inside, with a side of marinara.", price: 8.00, tag: "Popular", img: "mozzarella-sticks.jpg", url: S(1000043662, 1000299967) },
      { name: "Pita Bread", desc: "Warm, soft pita.", price: 3.50, img: "pita-bread.jpg", url: S(1000043662, 1000299973) },
      { name: "Garlic Bread", desc: "Bread topped with garlic & herb seasoning, baked to perfection.", price: 3.50, img: "garlic-bread.jpg", url: S(1000043662, 1000299977) },
      { name: "Garlic Bread with Cheese", desc: "A cross between garlic bread and pizza.", price: 4.50, img: "garlic-bread-cheese.jpg", url: S(1000043662, 1000299979) },
    ],
  },
  {
    id: "soups",
    ...
    items: [
      ...
      { name: "Soup of the Day", desc: "Ask for today's selection.", price: 5.95, img: "soup-of-the-day.jpg", url: S(1000043671, 1000299995) },
    ],
  },
  {
    id: "salads",
    ...
    items: [
      ...
      { name: "Full Greek Salad", desc: "Romaine, tomatoes, cucumbers, peppers, onions, kalamata olives, pepperoncini, feta.", price: 10.50, tag: "House", img: "full-greek-salad.jpg", url: S(1000043675, 1000300032) },
      ...
      { name: "Cajun Chicken Salad", desc: "Grilled cajun chicken over crisp greens with cheddar.", price: 11.95, img: "cajun-chicken-salad.jpg", url: S(1000043675, 1000300041) },
      ...
      { name: "Avocado Salad", desc: "Cucumbers, walnuts, raisins, red onion, tomatoes, avocado, parmesan.", price: 11.95, img: "avocado-salad.jpg", url: S(1000043675, 1000300047) },
      { name: "Grilled Chicken Salad", desc: "Grilled chicken, veg, kalamata olives, pepperoncini, cheddar.", price: 11.95, img: "grilled-chicken-salad.jpg", url: S(1000043675, 1000300050) },
      { name: "Chef Salad", desc: "Hard-boiled egg, ham, turkey, cheese, tomatoes, cucumbers & red onion.", price: 11.95, img: "chef-salad.jpg", url: S(1000043675, 1000300056) },
    ],
  },
  {
    id: "wings",
    ...
    items: [
      { name: "Wings (6 pcs)", desc: "Jumbo wings, tossed in sauce or served plain.", price: 9.95, tag: "Popular", img: "wings-6.jpg", url: S(1000043684, 1000300065) },
      { name: "Wings (12 pcs)", desc: "A dozen jumbo wings, tossed in sauce or served plain.", price: 14.95, img: "wings-12.jpg", url: S(1000043684, 1000300065) },
    ],
  },
  {
    id: "calzones",
    ...
    items: [
      { name: "Build Your Own Calzone", desc: "Pick your fillings — $7.95 + $1.50 per topping.", price: 7.95, img: "build-your-own-calzone.jpg", url: S(1000043687, 1000300072) },
      { name: "Steak Philly Calzone", desc: "Cheese steak, onions, green peppers, mushrooms and ranch sauce.", price: 11.95, img: "steak-philly-calzone.jpg", url: S(1000043687, 1000300079) },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { name: "Ham Italian Hoagie", desc: "Ham, salami, pepperoni, provolone, lettuce, tomato & mayo.", price: 10.95, tag: "Popular", img: "ham-italian-hoagie.jpg", url: S(1000043697, 1000300149) },
      ...
      { name: "Chicken Philly Sub", desc: "Grilled chicken, sautéed onions, peppers, mushrooms, provolone.", price: 10.95, img: "chicken-philly-sub.jpg", url: S(1000043697, 1000300158) },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Mykonos Spaghetti", desc: "Shrimp, onion, mushrooms, feta & mozzarella in marinara.", price: 14.95, img: "mykonos-spaghetti.jpg", url: S(1000043709, 1000300291) },
      { name: "Pasta Carbonara", desc: "Ham, bacon, mushrooms in creamy homemade alfredo.", price: 14.95, img: "pasta-carbonara.jpg", url: S(1000043709, 1000300296) },
      ...
      { name: "Pasta Marinara", desc: "Baked or traditional.", price: 11.95, img: "pasta-marinara.jpg", url: S(1000043709, 1000300323) },
      { name: "Lasagna", desc: "Layers of pasta packed with meat and cheese in red sauce.", price: 13.95, img: "lasagna.jpg", url: S(1000043709, 1000300331) },
      { name: "Rigatoni 4 Cheese", desc: "Parmesan, mozzarella, feta & provolone in creamy alfredo.", price: 13.95, img: "rigatoni-4-cheese.jpg", url: S(1000043709, 1000300336) },
      { name: "Cheese Chicken Tortellini", desc: "Chicken, mushrooms, onions, spinach in creamy alfredo.", price: 14.95, img: "cheese-chicken-tortellini.jpg", url: S(1000043709, 1000300353) },
      ...
      { name: "Chicken Parmesan", desc: "Breaded chicken, marinara & mozzarella over pasta.", price: 14.95, img: "chicken-parmesan.jpg", url: S(1000043839, 1000301050) },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Blue Cheese Burger", desc: "8oz patty with pineapple and blue cheese.", price: 12.95, img: "blue-cheese-burger.jpg", url: S(1000043818, 1000300945) },
      ...
      { name: "Fish Sub", desc: "5oz Atlantic cod, breaded & fried, tartar sauce, pickles on a hoagie.", price: 11.95, img: "fish-sub.jpg", url: S(1000043818, 1000300942) },
    ],
  },
  {
    id: "combo",
    ...
    items: [
      { name: "Soup & Salad Combo", desc: "A bowl of soup with a fresh side salad.", price: 10.95, img: "soup-salad-combo.jpg", url: S(1000043726, 1000300425) },
    ],
  },
  {
    id: "kids",
    ...
    blurb: "12 & under.",
    items: [
      { name: "Kid's Spaghetti", desc: "Butter, alfredo, marinara, meat sauce, or meatballs.", price: 6.95, img: "kids-spaghetti.jpg", url: S(1000043784, 1000300714) },
      { name: "Kid's 6\" Pizza", desc: "Classic cheese or create your own. +$1.50 each topping.", price: 6.95, img: "kids-pizza.jpg", url: S(1000043784, 1000300748) },
      { name: "Kid's Ham & Cheese Sandwich", desc: "A simple favorite.", price: 6.95, img: "kids-ham-cheese.jpg", url: S(1000043784, 1000300723) },
    ],
  },
  {
    id: "desserts",
    ...
    items: [
      ...
      { name: "Vanilla Almond Cake", desc: "Vanilla sponge with toasted almond cream.", price: 7.50, img: "vanilla-almond-cake.jpg", url: SLICE_HOME },
